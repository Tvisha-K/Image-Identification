...
sketch_to_be_drawn = quick_draw_data_set[random_number];

document.getElementById("sketch_to_be_drawn").innerHTML = "Sketch to be drawn : " + sketch_to_be_drawn;
...
function got_result(e, r) {
    ...
    if (e) {
        ...
        document.getElementById("confidence").innerHTML = "Confidence : " + Math.floor(r[0].confidence*100) + "%";
